...
const events = [
  ...
  { id: '15741', name: '(B) Tyneside Vagabonds Cc (N&Dca Champs)(Cheques To M Reed)', course: 'M100/20', distance: 100, fee: 10.00, date: '13 August 2017', length: 'long', closes: '01 August 2017', provisional: true },
  { id: '15766', name: 'Cramlington Cc', course: 'M21', distance: 21, fee: 8.50, date: '19 August 2017', length: 'medium', closes: '08 August 2017', provisional: true }
]
...
function calculateVetTimes (vets, event) {
  ...
  vets.forEach(r => {
    ...
    if (!rider) {
      console.error(`Vet rider missing from riders.json, add him manually using details from https://www.cyclingtimetrials.org.uk/rider/${r.id}`)
    }
    if (!rider.age) {
